...
'''
MAIN script to reproduce the results of the NER extrinsic task
we need to set some crucial parameters, such as the word embedding dimensions, 
the pretrained embeddings, the batch size, the learning rate, the epochs, the 
datasets (splittend into dev, test, train) and so on
'''
...
# single run of a specific epoch
