...
# use this script in order to produce embedding for a given text
# specifiyng the vocabulary

from train import args
# full tokenization of a vocabulary
...
# produce embedding for a specific word
...
# compute and save the embeddings of a given vocabulary
...
# main function, choose the task for which the embeddings must be generated 
