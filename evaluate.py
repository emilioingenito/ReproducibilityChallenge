...
# function that loads the datset and produces the embeddings of the words in the dictionary
...
# computes the uniform loss
def uniform_loss(x, t=2):
    return torch.pdist(x, p=2).pow(2).mul(-t).exp().mean().log()

# performs the analysis of different word similarity datasets 
# please check the paper, Table 2, for a better understanding 
# of the results and the Colab instance
...
# main function, produces a model 
